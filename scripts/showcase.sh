...
echo "  ATAK Bridge:       bash scripts/atak-bridge.sh"
echo "  GPS Position:      python3 tools/gps_tool.py position"
echo "  Model Backup:      su 0 $PY tools/model_tool.py list"
echo "  MAVLink Bridge:    python3 tools/mavlink_bridge.py test"
echo "  Hydra Display:     python3 tools/hydra_display.py demo"
