...
local scripts = {
  ...
  {cat="TACTICAL",name="GPS Position",desc="Display GPS fix and coordinates",
   detail="Launch YGPS app for full GPS.\nShows lat/lon/alt/sats.\nCan export position via clipboard."},
